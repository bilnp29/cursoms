...
import com.miranda.springboot.domain.Pagamento;
import com.miranda.springboot.domain.PagamentoComBoleto;
import com.miranda.springboot.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instaciandoTestDataBase() throws ParseException {
		...
		Produto p8 = new Produto(null, "Camisa", 800.00);
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4, cat8));
		p2.getCategorias().addAll(Arrays.asList(cat1, cat2, cat4, cat8));
		p3.getCategorias().addAll(Arrays.asList(cat1, cat4, cat8));
		p4.getCategorias().addAll(Arrays.asList(cat2));
		p5.getCategorias().addAll(Arrays.asList(cat3));
		p6.getCategorias().addAll(Arrays.asList(cat3));
		p7.getCategorias().addAll(Arrays.asList(cat4, cat8));
		...
		Cliente cli1 = new Cliente(null, "Bruno Miranda", "bilnp29@gmail.com", "01293478945", TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDETE, ped2, sdf.parse("20/10/2018 10:30"),
				null);
