...
public class Cliente implements Serializable {
	...
	// HashSet(). Onde não há repetições.
	// para mapeamento no banco de dados é utilizado as notações abaixo.

	@ElementCollection // Criando uma entidade fraca.
	@CollectionTable(name = "TELEFONE") // Nome da tabela no banco
	private Set<String> telefones = new HashSet<>();
	
	// Associações: Um Cliente tem muitos pedidos.
	...
	public Cliente(Integer id, String nome, String email, String cpfouCnpj, TipoCliente tipo) {
		...
		this.tipo = (tipo == null) ? null : tipo.getCod(); //Utilizando Operador ternario.
	}
