...
import com.miranda.springboot.dto.ProdutoDTO;
import com.miranda.springboot.resources.utils.URL;
import com.miranda.springboot.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<Produto> list = service.search(nomeDecoded,ids,page, linesParPage, orderBy, direction);
